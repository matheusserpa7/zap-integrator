...
class StoreWebhookEndpointRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'Informe um nome para o webhook.',
            'url.required' => 'Informe a URL de destino.',
            'event_type.required' => 'Selecione um evento.',
            'event_type.in' => 'O evento selecionado é inválido.',
            'payload_mode.required' => 'Informe o modo do payload.',
        ];
    }
